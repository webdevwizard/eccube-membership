...
namespace Plugin\LoginPlugin\Controller\MyPage;
...
use Eccube\Controller\Mypage\ChangeController;

use Plugin\LoginPlugin\Form\Type\CustomEntryType;


/**
 * Class CustomChangeController.
 */
class CustomChangeController extends ChangeController
{  
    /**
     * 会員情報編集画面.
     *
     * @Route("/mypage/change", name="mypage_change")
     * @Template("@LoginPlugin/Mypage/change.twig")
     */
